...
export class SimilarPeopleWorkflow {
    ...
    async execute({ profileUrl, topK }) {
        ...
        const classificationText = `${profileData.title} ${profileData.bio} ${webSearchResults.results.map((r) => r.snippet).join(' ')}`;
...
//# sourceMappingURL=similarPeople.js.map